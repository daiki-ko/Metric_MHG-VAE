...
Train_params = {
    ...
    'seed_list': [141], # seeds used for restarting training
...
#GrammarSeq2SeqVAEWithPredを用いるタスクTrainWithPredおよびConstrainedMolOptのときのみ使う
...
ConstructDatasetForBO_params  = deepcopy(Train_params)
